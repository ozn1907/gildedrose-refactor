...
### Gilded Rose Refactor – PHP/Laravel

A modern refactor of the classic Gilded Rose Kata implemented using PHP and Laravel.

This project focuses on clean, maintainable, and testable code, while fully preserving the original business rules. It’s a great resource for developers who want to explore refactoring techniques in Laravel or improve their PHP design skills.
composer fix-cs
